...
- Обзор литературы на 24.09.2026: `research/literature-review-2026-09-24.md`, 27 публикаций (включая три прежние) и 8 официальных источников; версии, карта чтения и BibTeX — в `research/literature-2026-09-24/`. Учтены PipePoison/PMPA и современные возможности Promptfoo/Garak; позиционирование в `docs/strategy.md` уточнено без заявления мирового приоритета. Новые live-эксперименты не выполнялись.
...
1. Завести HACK-задачу на G6 и собрать demo/submission narrative из frozen G5 report с учётом обзора литературы: показать cross-user policy boundary, отдельно attack success и protected gate, явно обозначить offline G4.
