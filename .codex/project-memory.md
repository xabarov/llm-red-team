...
1. Запустить бесплатную подготовку G5 Evaluation Matrix: matrix plan и budget estimate по уже сохранённым summaries.
2. Перед платными G5 runs согласовать OpenRouter budget, модели, число повторов и необходимость live defense interposition.
