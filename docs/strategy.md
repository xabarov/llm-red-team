...
Обновлено: 2026-09-24 (позиционирование сверено с литературой и документацией)
...
Promptfoo уже документирует memory-poisoning plugin, а Garak — многоходовые атаки на инструментальных агентов. Наше позиционирование — воспроизводимая проверка банковской cross-user policy-memory границы с backend evidence, IAM-решением и внешним последствием. Lifecycle-оценка уже представлена в MemSecBench; мировой приоритет этого подхода не заявляется. Источники и сравнение: [обзор литературы, разделы 5 и 8](../research/literature-review-2026-09-24.md).
